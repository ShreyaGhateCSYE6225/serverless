                                ...
                                Message: {
                                    Body: {
                                        Html: {
                                            ...
                                            <a href="https://prod.shreyaghate.me/v1/verifyUserEmail?email=${username}&token=${token}" "target="_blank">https://prod.shreyaghate.me/v1/verifyUserEmail?email=${username}&token=${token}</a>
                                            <p>Best,<br/>
