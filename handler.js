                                ...
                                Message: {
                                    Body: {
                                        Html: {
                                            ...
                                            <a href="http://prod.shreyaghate.me/v1/verifyUserEmail?email=${username}&token=${token}" "target="_blank">http://prod.shreyaghate.me/v1/verifyUserEmail?email=${username}&token=${token}</a>
                                            <p>Best,<br/>
